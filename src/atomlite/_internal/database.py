...
class Database:
    ...
    def __init__(
        ...
        self.connection.execute(
            f"CREATE TABLE IF NOT EXISTS {molecule_table}(key TEXT PRIMARY KEY, molecule MOL)",
        )
    ...
    def get_molecules(self, keys: str | typing.Iterable[str]) -> typing.Iterator[Entry]:
